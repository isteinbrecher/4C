...
{
  template void line_to_line_closest_point_projection<Sacado::ELRFad::DFad<double>, t_hermite,
      t_line2>(const ElementData<t_hermite, Sacado::ELRFad::DFad<double>>&,
      const ElementData<t_line2, Sacado::ELRFad::DFad<double>>&, Sacado::ELRFad::DFad<double>&,
      Sacado::ELRFad::DFad<double>&, ProjectionResult&, const bool);
}  // namespace GeometryPair
